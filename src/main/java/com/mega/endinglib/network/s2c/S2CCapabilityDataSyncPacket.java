...
public class S2CCapabilityDataSyncPacket {
    ...
    public static S2CCapabilityDataSyncPacket decode(FriendlyByteBuf friendlyByteBuf) {
        return new S2CCapabilityDataSyncPacket(friendlyByteBuf.readInt(), friendlyByteBuf.readUtf(), friendlyByteBuf.readNbt(), friendlyByteBuf.readEnum(CapabilitySyncType.class), SynchedCapabilityData.unpackCapabilityDataList(friendlyByteBuf));
    }
