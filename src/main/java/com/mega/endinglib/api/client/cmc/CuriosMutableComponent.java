...
public class CuriosMutableComponent {
    ...
    public CuriosMutableComponent appendAttributeFormat_noPercent(int p, FormatDescFunction args, boolean onlyClient) {
        //index 0 -> 属性值CF
        //index 1 -> 属性
        //index 2 -> 属性CF
        //index 3 -> 属性名
    ...
    public CuriosMutableComponent appendNegAttributeFormat_noPercent(int p, FormatDescFunction args, boolean onlyClient) {
        //index 0 -> 属性值CF
        //index 1 -> 属性
        //index 2 -> 属性CF
        //index 3 -> 属性名
    ...
    public CuriosMutableComponent appendAttributeFormat_noPercent(int p, FormatDescFunction args) {
        return this.appendAttributeFormat_noPercent(p, args, false);
    }

    public CuriosMutableComponent appendNegAttributeFormat_noPercent(int p, FormatDescFunction args) {
        return this.appendNegAttributeFormat_noPercent(p, args, false);
    }
