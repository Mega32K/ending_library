...
public class CameraAnimTypeArgumentType implements ArgumentType<String> {
    ...
    public static CameraAnimTypeArgumentType animType() {
        return new CameraAnimTypeArgumentType();
    }
