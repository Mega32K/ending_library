package com.mega.endinglib.command.entity;

import com.mega.endinglib.util.MUtils;
        ...
        return Commands.literal("redirect")
                ...
                .then(Commands.argument("targets", EntityArgument.entities())
                        ...
                        .then(Commands.argument("pos", BlockPosArgument.blockPos())
                                .executes(context -> redirect(context.getSource(), EntityArgument.getEntities(context, "targets"), MUtils.getCenter(BlockPosArgument.getLoadedBlockPos(context, "pos"))))
                        )
