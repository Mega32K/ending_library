...
public class ELServerCameraManager implements ICameraManager {
    ...
    public double getX(float partialTicks) {
        return Mth.lerp(partialTicks, this.xOld, this.x.getValue());
    }

    @Override
    public double getY(float partialTicks) {
        return Mth.lerp(partialTicks, this.yOld, this.y.getValue());
    }

    @Override
    public double getZ(float partialTicks) {
        return Mth.lerp(partialTicks, this.zOld, this.z.getValue());
    }
